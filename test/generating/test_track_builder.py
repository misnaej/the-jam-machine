...
class TestStripTrackEnds:
    ...
    def test_strip_track_ends_removes_token(self) -> None:
    ...
    def test_strip_track_ends_no_token_unchanged(self) -> None:
...
class TestExtractTracks:
    ...
    def test_extract_tracks_multi_track_piece(self, sample_piece_text: str) -> None:
    ...
    def test_extract_tracks_single_track(self) -> None:
    ...
    def test_extract_tracks_preserves_content(self) -> None:
...
class TestGetLastTrack:
    ...
    def test_get_last_track_returns_last(self, sample_piece_text: str) -> None:
...
class TestCombineTracks:
    ...
    def test_combine_tracks_builds_piece(self) -> None:
...
class TestGetNewContent:
    ...
    def test_get_new_content_extracts_generated_part(self) -> None:
...
class TestExtractNewBar:
    ...
    def test_extract_new_bar_gets_last_bar(self) -> None:
    ...
    def test_extract_new_bar_strips_track_end(self) -> None:
